...
export default function CE_NavbarHeader() {
            ...
            <div className={styles.container}>
                <div className={styles.highlight}>
                    ...
                    <div className={styles.highlightIcon}>
                        <ChevronsDownIcon className={styles.chevronIcon} />
                    </div>
                </div>
                <div className={styles.contact}>
                    ...
                    <Link href="/signin">
                        <Button size="small" className={styles.loginButton}>
                            <LoginIcon className="stroke-white" />
...
const styles = {
    container: `justify-end items-center min-[1070px]:flex hidden`,
