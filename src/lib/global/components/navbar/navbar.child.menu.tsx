...
import { T_BaseMenuItem } from './constants'
...
export default function NavbarChildMenu({
    subMenu,
    title,
}: T_NavbarChildMenuProps) {
    return (
...
const styles = {
    ...
    childMenuItems:
        'flex gap-x-16  gap-y-2 text-xl-regular text-red-primary flex-wrap',
}
